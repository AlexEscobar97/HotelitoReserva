...
public class Logued {
    ...
    public static List<UsuarioEmpleado> usuarioEmpleadoListLogued;
    public static List<Cliente> clienteListLogued;
    public static List<RespuestaGenerica> respuestaGeneticaListLogued;
